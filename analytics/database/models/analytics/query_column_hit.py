...
class QueryColumnHit(Base):
    __tablename__ = "query_column_hit"
    __table_args__ = (
        Index("query_column_hit_query_idx", "query_id"),
        {"schema": "analytics"},
    )
    ...
    is_condition = Column(Boolean, nullable=False, default=False)
    is_condition_foreign = Column(Boolean, nullable=False, default=False)
